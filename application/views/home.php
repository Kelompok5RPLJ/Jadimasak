...
<meta name="keywords" content="jadimasak, resepmasakan" /><!-- define keywords for search engines-->
<!--webfont-->
			            ...
			            <div class="row">
				            <div class="col-sm-6">
					            <ul class="multi-column-dropdown">
						            ...
						            <li><a href="<?php echo site_url('main_user/filter_products')?>">Gorengan</a></li>
